...
namespace bytedance_db_project
{
  ...
  private:
    ...
    std::unordered_map<int32_t, std::vector<int32_t>> index0_;
    std::unordered_map<int32_t, std::vector<int32_t>> index1_;
    std::unordered_map<int32_t, std::vector<int32_t>> index2_;
  };
} // namespace bytedance_db_project
